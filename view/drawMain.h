...
//设置
inline button_img button_setting(24, 23,43,43,WHITE,button_style::roundrect, "sources/image/files_ui/btn_settings_norm.png");
inline button_img button_setting_on(24, 23,43,43, WHITE,button_style::roundrect, "sources/image/files_ui/btn_settings_hover.png");
//播放
inline button_img button_play (605,694,70,70,WHITE,button_style::roundrect,"sources/image/control/btn_play_norm.png");
inline button_img button_play_on (605,694,70,70,WHITE,button_style::roundrect,"sources/image/control/btn_play_hover.png");
//暂停
inline button_img button_pause(605,694,70,70,WHITE,button_style::roundrect,"sources/image/control/btn_pause_norm.png");
inline button_img button_pause_on(605,694,70,70,WHITE,button_style::roundrect,"sources/image/control/btn_pause_hover.png");
//回退
...
//打开文件
inline button_img button_open_file(240,25,43,126,WHITE,button_style::roundrect,"sources/image/files_ui/btn_add_file_norm.png");
inline button_img button_open_file_on(240,25,43,126,WHITE,button_style::roundrect,"sources/image/files_ui/btn_add_file_hover.png");
