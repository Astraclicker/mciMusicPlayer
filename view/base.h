...
//构建功能基础按钮
inline button base_function(
    50,
    50,
    WHITE,
    button_style::roundrect
);
inline button base_function_setting(
    50,
    70,
    0x808080,
    button_style::roundrect
);
inline button base_vol(
    40,
    40,
    0x808080,
    button_style::roundrect
);
inline button base_vol_on(
    40,
    40,
    WHITE,
    button_style::roundrect
);
inline button base_function_setting_on(
    50, 70,
    WHITE,
    button_style::roundrect
);
inline button base_setting(
    length_window - length_window / 4,
